...
class UserModel {
  ...
  UserModel copyWith({
    ...
    double? delayCharges,
    double? buildingFund,
    double? roomTransferFees,
    double? totalReceivable,
    double? totalReceived,
    double? closingBalance,
    double? fixedMonthlyCharges,
    ...
    return UserModel(
      ...
      sinkingFund: sinkingFund ?? this.sinkingFund,
      ...
      delayCharges: delayCharges ?? this.delayCharges,
      buildingFund: buildingFund ?? this.buildingFund,
      roomTransferFees: roomTransferFees ?? this.roomTransferFees,
      totalReceivable: totalReceivable ?? this.totalReceivable,
      totalReceived: totalReceived ?? this.totalReceived,
      closingBalance: closingBalance ?? this.closingBalance,
      fixedMonthlyCharges: fixedMonthlyCharges ?? this.fixedMonthlyCharges,
